...
The main objects within the simulation are Reference Objects, and are in separate files within the /R directory.
...
The main functions that users will want to call are within the simulation.R file
